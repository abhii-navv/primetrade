...
const styles = {
  ...
  select: { width: '100%', background: '#111', border: '1px solid #333', borderRadius: 8, padding: '10px 14px', color: '#fff', fontSize: 14, boxSizing: 'border-box' },
  ...
  success: { background: '#0f2a1a', border: '1px solid #0a5a2a', color: '#4ade80', borderRadius: 8, padding: '10px 14px', fontSize: 13, marginBottom: 20 },
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.field}>
            ...
            <input style={styles.input} type="password" required minLength={6} value={form.password}
